...
public class CombatInstructor {
    ...
    public boolean combatInstructor(Script script) throws InterruptedException {
        ...
        if (Utils.checkSkippable(bronzeDaggerComponent, skipString1)) {
            script.log("Skipping to melee section");
            meleeSection(script);
            return true;
        } else if (Utils.checkSkippable(bronzeDaggerComponent, skipString2a) || Utils.checkSkippable(
                bronzeDaggerComponent, skipString2b)) {
            rangedSection(script);
            return true;
        } else if (Utils.checkSkippable(bronzeDaggerComponent, skipString3)) {
            return true;
        }
